module Cultivation
  class SaveBatch
    ...
    def task_templates
      [
        {:phase => 'Clone', :task_category => '', :name => 'Clone', :duration => 17, :days_from_start_date => 0, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'Clone', :task_category => 'Prepare', :name => 'Prepare', :duration => 1, :days_from_start_date => 0, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'Clone', :task_category => 'Clone', :name => 'Clone', :duration => 1, :days_from_start_date => 2, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'Clone', :task_category => 'Clean', :name => 'Clean', :duration => 1, :days_from_start_date => 4, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG1', :task_category => '', :name => 'VEG1', :duration => 14, :days_from_start_date => 18, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'VEG1', :task_category => 'Plant', :name => 'Plant', :duration => 1, :days_from_start_date => 18, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG1', :task_category => 'Plant', :name => 'Mix “Loose” Rockwool and Water', :duration => 1, :days_from_start_date => 18, :estimated_hours => 0.5, :no_of_employees => 2, :materials => 'Rockwool, Cutters, Water, Nutrients, Micronutrients', :is_phase => 'false', :is_category => 'false'},
        ...
        {:phase => 'VEG1', :task_category => 'Clean', :name => 'Clean', :duration => 1, :days_from_start_date => 18, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG1', :task_category => 'Waiting', :name => 'Waiting', :duration => 12, :days_from_start_date => 20, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG2', :task_category => '', :name => 'VEG2', :duration => 1, :days_from_start_date => 19, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'VEG2', :task_category => 'Transfer', :name => 'Transfer', :duration => 1, :days_from_start_date => 19, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG2', :task_category => 'Clean', :name => 'Clean', :duration => 1, :days_from_start_date => 32, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'VEG2', :task_category => 'Waiting', :name => 'Waiting', :duration => 14, :days_from_start_date => 33, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'FLOWER', :task_category => '', :name => 'FLOWER', :duration => 56, :days_from_start_date => 33, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'FLOWER', :task_category => 'Transfer', :name => 'Transfer', :duration => 1, :days_from_start_date => 33, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'FLOWER', :task_category => 'Clean', :name => 'Clean', :duration => 1, :days_from_start_date => 48, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'FLOWER', :task_category => 'Waiting', :name => 'Waiting', :duration => 56, :days_from_start_date => 48, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'HARVEST', :task_category => '', :name => 'HARVEST', :duration => 7, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'HARVEST', :task_category => 'Cut Down', :name => 'Cut Down', :duration => 1, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'HARVEST', :task_category => 'Hang', :name => 'Hang', :duration => 1, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'HARVEST', :task_category => 'Clean', :name => 'Clean', :duration => 1, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'HARVEST', :task_category => 'Waiting', :name => 'Waiting', :duration => 7, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'TRIM / PACKAGE', :task_category => '', :name => 'TRIM / PACKAGE', :duration => 5, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'true', :is_category => 'false'},
        {:phase => 'TRIM / PACKAGE', :task_category => 'Trim', :name => 'Trim', :duration => 2, :days_from_start_date => 105, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'TRIM / PACKAGE', :task_category => 'Package', :name => 'Package', :duration => 2, :days_from_start_date => 107, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
        ...
        {:phase => 'TRIM / PACKAGE', :task_category => 'Clean ', :name => 'Clean', :duration => 1, :days_from_start_date => 117, :estimated_hours => nil, :no_of_employees => nil, :materials => nil, :is_phase => 'false', :is_category => 'true'},
