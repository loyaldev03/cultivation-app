  ...
  class SeedCatalogue
    ...
    def sales_template
      [
        ...
        {label: 'Concentrate (solid each)', category: Constants::SALES_PRODUCT_KEY, key: 'concentrate_solid each', uom_dimension: 'piece'},
        {label: 'Edible', category: Constants::SALES_PRODUCT_KEY, key: 'edible', uom_dimension: 'weight'},
        {label: 'Edible (each)', category: Constants::SALES_PRODUCT_KEY, key: 'edible_each', uom_dimension: 'piece'},
        {label: 'Extract (liquid)', category: Constants::SALES_PRODUCT_KEY, key: 'extract_liquid', uom_dimension: 'volume'},
        {label: 'Extract (liquid-each)', category: Constants::SALES_PRODUCT_KEY, key: 'extract_liquid_each', uom_dimension: 'piece'},
        {label: 'Extract (solid)', category: Constants::SALES_PRODUCT_KEY, key: 'extract_solid', uom_dimension: 'weight'},
        {label: 'Extract (solid-each)', category: Constants::SALES_PRODUCT_KEY, key: 'extract_solid_each', uom_dimension: 'piece'},
        {label: 'Liquid', category: Constants::SALES_PRODUCT_KEY, key: 'liquid', uom_dimension: 'volume'},
        {label: 'Liquid (each)', category: Constants::SALES_PRODUCT_KEY, key: 'liquid_each', uom_dimension: 'piece'},
        {label: 'Pre-Roll Flower', category: Constants::SALES_PRODUCT_KEY, key: 'pre_roll_flower', uom_dimension: 'piece'},
        {label: 'Pre-Roll Leaf', category: Constants::SALES_PRODUCT_KEY, key: 'pre_roll_leaf', uom_dimension: 'piece'},
        {label: 'Suppository (each)', category: Constants::SALES_PRODUCT_KEY, key: 'suppository_each', uom_dimension: 'piece'},
        {label: 'Tincture', category: Constants::SALES_PRODUCT_KEY, key: 'tincture', uom_dimension: 'volume'},
        {label: 'Tincture (each)', category: Constants::SALES_PRODUCT_KEY, key: 'tincture_each', uom_dimension: 'piece'},
        {label: 'Topical', category: Constants::SALES_PRODUCT_KEY, key: 'topical', uom_dimension: 'volume'},
        {label: 'Topical (liquid)', category: Constants::SALES_PRODUCT_KEY, key: 'topical_liquid', uom_dimension: 'volume'},
        {label: 'Topical (liquid-each)', category: Constants::SALES_PRODUCT_KEY, key: 'topical_liquid_each', uom_dimension: 'piece'},
        {label: 'Topical (solid)', category: Constants::SALES_PRODUCT_KEY, key: 'topical_solid', uom_dimension: 'weight'},
        {label: 'Topical (solid-each)', category: Constants::SALES_PRODUCT_KEY, key: 'topical_solid_each', uom_dimension: 'piece'},
        {label: 'Vape Oil', category: Constants::SALES_PRODUCT_KEY, key: 'vape_oil', uom_dimension: 'volume'},
        {label: 'Vape Oil (each)', category: Constants::SALES_PRODUCT_KEY, key: 'vape_oil_each', uom_dimension: 'piece'},
        {label: 'Wax', category: Constants::SALES_PRODUCT_KEY, key: 'wax', uom_dimension: 'weight'},
        {label: 'Other', category: Constants::SALES_PRODUCT_KEY, key: 'other', uom_dimension: 'weight'},
