...
export default class TreemapApp extends React.Component {
  ...
  componentDidMount(){
    ...
    d3.json(this.props.url).then(function(data){
      ...
      svg
        ...
        .attr('font-size', '12px')
        .attr('fill', 'white').append('tspan').attr('x', function(d){ return d.x0+5}).attr('y', function(d){ return d.y0+40}).text(function(d){ return d.data.value + ' plants' })
