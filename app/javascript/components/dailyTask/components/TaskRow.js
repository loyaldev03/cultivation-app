...
import { wbsWidth, taskWidth, locationWidth, btnWidth, statusWidth } from './TaskTableStyles'
    ...
    return (
      <React.Fragment>
        <div className="flex items-center pv1 dark-gray">
          <div className="flex items-center justify-center f6 pa2" style={wbsWidth}>
            { wbs }
          </div>
          ...
          <div className="flex items-center justify-start pa2" style={taskWidth}>
            ...
            <span className="f6 pointer" onClick={this.onExpand}>{task}</span>
          </div>
