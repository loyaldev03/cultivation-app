    ...
    return (
      <React.Fragment>
        ...
        <div className="ph4 mb2 flex">
          <div className="w-100">
            <p className="f7 fw3 gray mt0 mb0 pa0 lh-copy">Each mother plant has its own <strong>Plant ID</strong>.</p>
            <p className="f7 fw3 gray mt0 mb2 pa0 lh-copy"> If you already have them, paste Plant IDs like below:</p>
            <textarea
              rows="5"
        ...
        <div className="ph4 mb3 flex justify-between">
          <label className="f6 fw5 db mb1 gray">Mother plants are purchased</label>
