    ...
    return (
      <React.Fragment>
        <div className="ph4 mt3 mb3">
          ...
          <p className="f7 fw3 gray mt2">It is recommended to add stock by invoice number.</p>
        </div>

        <div className="ph4 mb3 flex">
          <div className="w-30">
            <TextInput label={'Quantity'} value={this.state.quantity} onChange={this.onQuantityChanged} />
          </div>
          ...
          <div className="w-60 pl3">
            <TextInput label={'Package Id'} value={this.state.package_id} onChange={this.onPackageIdChanged} />
          </div>
        </div>

        <hr className="mt3 m b--light-gray w-100" />
        <div className="ph4 mb3 mt3">
          <span className="f6 fw6 dark-gray">Where the seeds are sourced from?</span>
        </div>
        <div className="ph4 mb3 flex">
          <div className="w-100">
        ...
        <div className="w-100 mt4 pa4 bt b--black-10 flex items-center justify-between">
          ...
          <a className="db pv2 ph3 bg-green white bn br2 ttu tracked link dim f6 fw6" href="#" >
            Preview &amp; Save
          </a>
        </div>
      </React.Fragment>
