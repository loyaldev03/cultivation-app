...
const LocationSingleValue = ({ children, ...props }) => (
  <components.SingleValue {...props}>
    <div className="flex flex-row items-center">
      {/* {props.data.f_id && (
        <span className="f7 fw6 bg-light-blue dark-blue ph2 pv1 ml1 ttu br2">
      ...
      {props.data.rw_id && (
        <span>
          <span className="f6 fw6 mh1 gray">&#183;</span>
      ...
      {props.data.t_id && (
        <span>
          <span className="f6 fw6 mh1 gray">&#183;</span>
          <span className="f7 fw6 bg-black-10 dark-gray ph2 pv1 ml1 ttu br2">
            {props.data.t_code}
          </span>
        </span>
      )}
